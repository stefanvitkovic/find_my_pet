...
<body style="">
    ...
    <div id="app">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/how_to_use') }}">Kako se koristi</a>
                        </li>
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            ...
                            @else
                                <a class="nav-link" href="{{ route('users') }}">Profil</a>
                            @endif
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('pets') }}">Ljubimci</a>
                        </li>                        
        ...
        <nav class="navbar fixed-bottom navbar-expand-lg navbar-dark bg-black shadow-sm" style="color:white !important">
            <div class="container">
            ...
            {{-- <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
              ...
              <div class="navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav me-auto d-inline-block">
                    <li class="nav-item me-auto  d-inline-block">
                        <a class="nav-link missing missing_nav_button" href="{{ route('pets.missing') }}">Traže se</a>
                    </li>
                </ul>
                <ul class="navbar-nav ms-auto  d-inline-block float-end">
                    <li class="nav-item d-inline-block">
                        <a class="nav-link" href="{{ route('products.list') }}">Proizvodi</a>
                    </li>
                    <li class="nav-item d-inline-block">
                        <a class="nav-link fs-3" href="{{ route('cart.list') }}"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
                    </li>
